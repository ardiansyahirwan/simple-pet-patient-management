<x-layouts.app>
    <x-slot:title>Clinic Home Page</x-slot:title>
    <!-- Jumbotron -->
        ...
        <div class="flex flex-col items-center justify-between lg:flex-row py-16">
            <div class=" relative">
                <div class="lg:max-w-xl lg:pr-5 relative z-40">
                    ...
                    <h2 class="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                        Solution Animal be
                        <span class="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash text-amber-300">Healthly</span>
                    </h2>
                    <p class="text-base text-gray-700">We make your animals be happy and more healtly. You can get more closely with us. Get make appointment !!</p>
                    <div class="mt-10 flex flex-col items-center md:flex-row">
                        {{-- <a href="/" class="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-red-500 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                            View More</a> --}}
                        <a href="{{url('app')}}" aria-label="" class="group bg-amber-300 text-white px-6 py-4 rounded-xl inline-flex items-center font-bold text-g1">Login For More
            ...
            <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
                ...
                <div class="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                     <img class="w-[400px] h-[400px] object-cover" src="{{asset('storage/img/animal.jpg')}}">
                </div>
            </div>
        </div>
    </div> 
